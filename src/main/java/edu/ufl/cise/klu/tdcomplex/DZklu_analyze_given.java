 ...
 */
public class DZklu_analyze_given extends DZklu_internal
{
	 ...
	 * @return
	 */
	protected static KLU_symbolic klu_z_alloc_symbolic(int n, int[] Ap, int[] Ai, KLU_common Common)
	{
		...
		Q = klu_z_malloc_int(n, Common) ;
		R = klu_z_malloc_int (n+1, Common) ;
		Lnz = klu_z_malloc_dbl (n, Common) ;
	 ...
	 * @return
	 */
	public static KLU_symbolic klu_z_analyze_given(int n, int[] Ap, int[] Ai,
			int[] Puser, int[] Quser, KLU_common Common)
	{
		...
		if (do_btf != 0)
		{
			...
			Work = klu_z_malloc_int (4*n, Common) ;
			Pinv = klu_z_malloc_int (n, Common) ;
			if (Puser != null)
			{
				Bi = klu_z_malloc_int (nz+1, Common) ;
			}
			else
			{
				Bi = Ai ;
